...
public class S_60104_1 : MonoBehaviour
{
    ...
    [SerializeField] private s_60104_1[] dialogue;
    // Start is called before the first frame update
    void Start()
    {
        MainMenu_s.scenenumber++;
        MainMenu_s.beforedays = "6월 04일";
        MainMenu_s.nextdays = "6월 06일";
