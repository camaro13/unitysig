...
public class S_50508_3 : MonoBehaviour
{
    ...
    [SerializeField] private s_50508_3[] dialogue;
    // Start is called before the first frame update
    void Start()
    {
        MainMenu_s.scenenumber++;
        MainMenu_s.beforedays = "5월 08일";
        MainMenu_s.nextdays = "5월 10일";
