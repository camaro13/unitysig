...
public class S_42630_2 : MonoBehaviour
{
    ...
    [SerializeField] private s_42630_2[] dialogue;
    // Start is called before the first frame update
    void Start()
    {
        MainMenu_s.scenenumber++;
        MainMenu_s.beforedays = "4월 30일";
        MainMenu_s.nextdays = "5월 05일";
