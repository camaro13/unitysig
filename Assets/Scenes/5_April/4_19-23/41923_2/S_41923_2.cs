...
public class S_41923_2 : MonoBehaviour
{
    ...
    [SerializeField] private s_41923_2[] dialogue;
    // Start is called before the first frame update
    void Start()
    {
        MainMenu_s.scenenumber++;
        MainMenu_s.beforedays = "4월 23일";
        MainMenu_s.nextdays = "4월 26일";
